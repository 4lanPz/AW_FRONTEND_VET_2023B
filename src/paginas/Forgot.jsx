		...
		<>
		    <div className="bg-white flex justify-center items-center w-1/2">
		        ...
		        <div className="md:w-4/5 sm:w-full">
		            ...
		            <h1 className="text-3xl font-semibold mb-2 text-center uppercase  text-gray-500">Recuperar Contraseña</h1>
		            <small className="text-gray-400 block my-4 text-sm">Ingrese su email para ayudarlo a recuperar su cuenta</small>
		            ...
		            <form onSubmit={handleSubmit}>
		                ...
		                <div className="mb-1">
		                    ...
		                    <input type="email" placeholder="Ingrese su email" className="block w-full rounded-md border border-gray-300 focus:border-purple-700 focus:outline-none focus:ring-1 focus:ring-purple-700 py-1 px-1.5 text-gray-500"
		                    name='email' 
